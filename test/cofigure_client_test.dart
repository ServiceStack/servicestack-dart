...
void main() {
  ...
  test('Can populate ClientOptions', () async {
    var options = ClientOptions()..ignoreCertificatesFor=['dev.servicestack.com:5001','local.servicestack.com'];
  ...
  test('Can populate ClientOptions with urls', () async {
    var options = ClientOptions(baseUrl:'https://baseUrl.com', ignoreCert:true)
      ..ignoreCertificatesFor.addAll(['https://dev.servicestack.com:5001','http://local.servicestack.com']);
