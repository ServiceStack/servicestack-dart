...
Map<String, TypeInfo> TypeInfos = <String, TypeInfo> {
    ...
    'Tuple4<T1,T2,T3,T4>': new TypeInfo(TypeOf.GenericDef,create:() => new Tuple4()),
    'KeyValuePair<K,V>': new TypeInfo(TypeOf.GenericDef,create:() => new KeyValuePair()),
    ...
    'CancelRequest': new TypeInfo(TypeOf.Class, create:() => new CancelRequest()),
    'CancelRequestResponse': new TypeInfo(TypeOf.Class, create:() => new CancelRequestResponse()),
    'UpdateEventSubscriber': new TypeInfo(TypeOf.Class, create:() => new UpdateEventSubscriber()),
    'UpdateEventSubscriberResponse': new TypeInfo(TypeOf.Class, create:() => new UpdateEventSubscriberResponse()),
    'GetEventSubscribers': new TypeInfo(TypeOf.Class, create:() => new GetEventSubscribers()),
    ...
    'RegenerateApiKeysResponse': new TypeInfo(TypeOf.Class, create:() => new RegenerateApiKeysResponse()),
...
TypeContext _ctx = new TypeContext(typeName: 'JsonConverters', types: TypeInfos);
...
class Register implements IReturn<RegisterResponse>, IPost, IConvertible
{
    ...
    Register.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class RegisterResponse implements IConvertible
{
    ...
    RegisterResponse.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UnAssignRoles implements IReturn<UnAssignRolesResponse>, IPost, IConvertible
{
    ...
    UnAssignRoles.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UnAssignRolesResponse implements IConvertible
{
    ...
    UnAssignRolesResponse.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class GetEventSubscribers implements IConvertible
{
    ...
    GetEventSubscribers.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class Tuple2<T1, T2> implements IConvertible
{
    ...
    Tuple2.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class Tuple3<T1, T2, T3> implements IConvertible
{
    ...
    Tuple3.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class Tuple4<T1, T2, T3, T4> implements IConvertible
{
    ...
    Tuple4.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class KeyValuePair<K,V> implements IConvertible
{
    ...
    KeyValuePair.fromJson(Map<String, dynamic> json) { fromMap(json); }
